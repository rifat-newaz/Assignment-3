...
?>
              <h4>Hello Customer! let's get registered!</h4>
              ...
              <form action="registration_process.php" method="post" class="pt-3">
                ...
                <div class="mt-3">
                  <button type="submit" name="reg" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">SIGN UP</button>
                </div>
