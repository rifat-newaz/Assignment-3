...
<?php require_once 'includes/sidebar.php' ; ?>
	...
	if($_REQUEST['message']=="success"){
		...
		echo  "<font color='green'>Amount Successfully Transfer!</font>";
	}
	    else {
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-lg" placeholder="Transfer Amount" name="Amount" aria-label="Deposit Amount">
                  </div>
                  <div class="form-group">
                    <label>Transfer To (Email)</label>
                    <input type="email" class="form-control form-control-lg" placeholder="Transfer Amount to Email" name="transfer_to" aria-label="Deposit Amount">
                  </div>
                  <div class="form-group">
                    <label>Details</label>
                ...
                <div class="mt-3">
                  ...
                  <button type="submit" name="transfer" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn float-right">SAVE</button>
                </div>
                </div>
				</form>
