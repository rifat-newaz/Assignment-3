...
<?php require_once 'includes/sidebar.php' ; ?>
	...
	if($_REQUEST['message']=="success"){
		...
		echo  "<font color='green'>Amount Successfully Deposited!</font>";
	}
	    else {
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-lg" placeholder="Deposite Amount" name="Amount" aria-label="Deposit Amount">
                  </div>
                  <div class="form-group">
                    <label>Details</label>
                ...
                <div class="mt-3">
                  ...
                  <button type="submit" name="deposite" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn float-right">SAVE</button>
                </div>
                </div>
				</form>
